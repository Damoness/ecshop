...
-(void)done{
    ...
    NSString *shengfen = [NSString stringWithFormat:@"%@",self.state[[self.pickerView selectedRowInComponent:0]]];
    NSLog(@"done:%@",self.resultString);
    
    [self.delegate toolBarDoneBtnHaveClicked:self resultString:self.resultString shengfen:shengfen];
